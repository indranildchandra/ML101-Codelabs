...
def ID3Example(data, uniqs, remaining_atts, target_attribute):
    ...
    for att_value in uniq_att_values:
        ...
        node['nodes'][att_value] = ID3Example(partition, uniqs, remaining_atts_for_subtrees, target_attribute)
...
def main():
    ...
    root = ID3Example(data, uniqs, remaining_attributes, target_attribute)
